...
echo "✓ Camera resolution: 1280×720 (matching XhandMultimodalCollection.py)"
echo "✓ Processing: resize to 240×240 (INTER_AREA) → crop to 160×240 (top-left)"
echo "✓ Model input: 160×240 → resize to 240×240 → CenterCrop to 224×224"
echo ""
